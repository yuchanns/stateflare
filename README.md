...
THE ENTIRE CODEBASE IS GENERATED BY AI (GITHUB AGENT TASK) WITH HUMAN-ASSISTED CODE REVIEW.
...
本仓库使用人工智能（AI）工具生成代码。
整个代码库由 AI（GitHub Agent Task）生成，并经过人工辅助代码审查。
虽然我们力求准确性和可靠性，但请注意，AI 生成的内容可能包含错误，
不应仅依赖于关键应用程序。
请始终审查和验证代码，以确保其符合您的要求和标准。
```
