...
describe('getSiteOrigin', () => {
  ...
  it('should normalize URLs with and without trailing slash to the same value', () => {
    // This handles redirect scenarios where xxx.github.io/yyy redirects to xxx.github.io/yyy/
    // Both should be tracked under the same site origin: xxx.github.io/yyy/
    expect(getSiteOrigin('https://xxx.github.io/yyy')).toBe('https://xxx.github.io/yyy/');
    expect(getSiteOrigin('https://xxx.github.io/yyy/')).toBe('https://xxx.github.io/yyy/');
    
    // Verify they are identical
    const withoutSlash = getSiteOrigin('https://xxx.github.io/yyy');
    const withSlash = getSiteOrigin('https://xxx.github.io/yyy/');
